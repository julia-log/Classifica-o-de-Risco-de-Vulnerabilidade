...
O projeto reforça o uso de:

Estruturas condicionais (if, elif, else)

Operadores lógicos (and)

Boas práticas de exibição de resultados em Python

Objetivo: Simular um sistema de análise de segurança que categoriza riscos como críticos, altos, médios ou baixos.

Habilidade desenvolvida: Controle de fluxo e tomada de decisão com base em condições lógicas.
